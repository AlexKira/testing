...
def template_two(request):
    view = "template_two"
    t = get_template('myview.html')# получить шаблон'myview.html' и присвоить его t
    html = t.render(Context({'name': view}))# отобразить t подставив в переменную 'name' значение переменной view
    return HttpResponse(html)

def template_three_simple(request):
    view = "template_three"
    return render_to_response('myview.html', {'name': view}) #отобразить в ответе шаблон 'myview.html',переменной 'name'=view
